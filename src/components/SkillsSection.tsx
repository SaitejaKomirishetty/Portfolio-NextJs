...
const skills = [
    { icon: <IconBrandHtml5 size={48} stroke={1.5} />, title: 'HTML' },
    { icon: <IconBrandCss3 size={48} stroke={1.5} />, title: 'CSS' },
    {
        icon: <IconBrandJavascript size={48} stroke={1.5} />,
        title: 'JAVASCRIPT',
    },
    { icon: <IconBrandReact size={48} stroke={1.5} />, title: 'REACT' },
    { icon: <IconBrandNextjs size={48} stroke={1.5} />, title: 'NEXT' },
    {
        icon: <IconBrandTailwind size={48} stroke={1.5} />,
        title: 'TAILWIND CSS',
    },
    { icon: <IconBrandRedux size={48} stroke={1.5} />, title: 'REDUX' },
    {
        icon: <IconBrandTypescript size={48} stroke={1.5} />,
        title: 'TYPESCRIPT',
    },
    { icon: <IconBrandCypress size={48} stroke={1.5} />, title: 'CYPRESS' },
    { icon: <IconBrandBootstrap size={48} stroke={1.5} />, title: 'BOOTSTRAP' },
    ...
    { icon: <IconBrandGit size={48} stroke={1.5} />, title: 'GIT' },
    { icon: <IconBrandGithub size={48} stroke={1.5} />, title: 'GITHUB' },
    { icon: <IconBrandGitlab size={48} stroke={1.5} />, title: 'GITLAB' },
    {
        icon: (
            <svg
                xmlns='http://www.w3.org/2000/svg'
    ...
    { icon: <IconBrandMysql size={48} stroke={1.5} />, title: 'MYSQL' },
    { icon: <IconBrandAws size={48} stroke={1.5} />, title: 'AWS' },
];
